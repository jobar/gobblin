...
/**
 * Tests for {@link TimestampedRecordOrJsonStringTimeBasedWriterPartitioner}.
 * Copied and updated from gobblin-core:org.apache.gobblin.writer.partitioner.TimeBasedAvroWriterPartitionerTest
 */
@Test
public class TestTimestampedRecordOrJsonStringTimeBasedWriterPartitioner {

    private static final String SIMPLE_CLASS_NAME = TestTimestampedRecordOrJsonStringTimeBasedWriterPartitioner.class.getSimpleName();
    ...
    private State getBasicState() {
        ...
        properties.setProp(ConfigurationKeys.WRITER_PARTITIONER_CLASS, TimestampedRecordOrJsonStringTimeBasedWriterPartitioner.class.getName());
